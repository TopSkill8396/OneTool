        ...
        <section className="w-full relative flex items-center justify-center flex-col px-4 md:px-0 py-8">
            ...
            <Wrapper>
                {/* <div className="absolute inset-0 dark:bg-[linear-gradient(to_right,#e2e8f0_1px,transparent_1px),linear-gradient(to_bottom,#e2e8f0_1px,transparent_1px)] bg-[linear-gradient(to_right,#161616_1px,transparent_1px),linear-gradient(to_bottom,#161616_1px,transparent_1px)] bg-[size:4rem_4rem] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_110%)] -z-10 h-[150vh]" /> */}
                 ...
                 <div className="absolute top-0 left-0 inset-0 w-[50vw] -z-10 h-[150vh]">
                        <Image
                            // className="absolute top-0 left-0 inset-0 w-[50vw] -z-10 h-[150vh]"
                            src="/assets/top_back.png"
                            alt="Hero background"
                            layout="fill"
                            objectFit="cover"
                            quality={100}
                    ...
                    <div className="flex flex-col items-center justify-center py-20 h-full">
                        ...
                        <button className="group relative grid overflow-hidden rounded-full px-4 py-1 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
                            ...
                            <span className="z-10 py-0.5 text-sm text-neutral-100 flex items-center justify-center gap-1.5">
                                <Image src="/icons/OASIS.gif" alt="✨" width={24} height={24} className="w-16 h-16 rounded-full" />
                        ...
                        <div className="flex flex-col items-center mt-8 max-w-3xl w-11/12 md:w-full">
                            <h1 className="text-4xl md:text-6xl lg:textxl md:!leading-snug font-semibold text-center bg-clip-text bg-gradient-to-b from-gray-50 to-gray-50 text-transparent">
                                Empower Your Career with AI Voice Assistants
                            </h1>
                            <p className="text-base md:text-lg text-foreground/80 mt-6 text-center">
                                We're an AI-driven company dedicated to innovation, streamlining operations, and accelerating success through our state-of-the-art AI solutions.
                            </p>
